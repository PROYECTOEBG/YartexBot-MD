...
return conn.reply(jid, text, { key: { fromMe: areJidsSameUser(fakeJid, conn.user.id), participant: fakeJid, ...(fakeGroupJid ? { remoteJid: fakeGroupJid } : {}) }, message: { conversation: fakeText }, ...options })
	 ...
	 sendUrl: {
            value(jid, text = '', quoted, options) {
                let content = generateWAMessageFromContent(jid, { extendedTextMessage: {  contextInfo: { ...options }, text }}, { quoted, ...options })
                return conn.relayMessage(jid, content.message, { messageId: content.key.id })
            },
            writable: true,
        },
...
let canalId = ["https://chat.whatsapp.com/I5ZCL8q7Gz00D34nRFQlmi", "https://chat.whatsapp.com/I5ZCL8q7Gz00D34nRFQlmi", "https://chat.whatsapp.com/I5ZCL8q7Gz00D34nRFQlmi", "https://chat.whatsapp.com/I5ZCL8q7Gz00D34nRFQlmi"]
let canalNombre = ["𝙋𝙧𝙤𝙮𝙚𝙘𝙩𝙤𝙓//𝙀𝘽𝙂"]
